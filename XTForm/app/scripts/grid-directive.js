...
// 3 domain objects: editor, edit, columns, rows
  ...
  angular.module("xtformApp").directive("gridScreen", function($http) {
    return {
      restrict: 'E',
  ...
  angular.module("xtformApp").directive("gridColumns", function() {
    return {
      restrict: 'E',
  ...
  angular.module("xtformApp").directive("gridColumn", function() {
    return {
      restrict: 'E',
      require: '^gridColumns',
  ...
  angular.module("xtformApp").directive("grid", function() {
    return {
      restrict: 'E',
      templateUrl: "views/common/templates/as_table.html",
      replace: true,
      controller: function($scope) {
  ...
  angular.module("xtformApp").directive("withInlineEditor", function() {
    return {
      restrict: 'A',
      require: '^gridScreen',
  ...
  angular.module("xtformApp").directive("editorInitializer", function($compile, $templateCache) {
    return {
      restrict: 'E',
      templateUrl: 'views/common/templates/editor_initializer.html',
      controller: function($scope) {
      ...
      link: function(scope, element, attributes) {
        scope.$on('edit', function(e, row) {
          var editor = $compile($templateCache.get("views/common/templates/editor.html"))(scope);
